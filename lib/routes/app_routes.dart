...
//監聽 AuthBloc 狀態變化，並通知 GoRouter  refreshListenable
class AuthStreamToListenable extends ChangeNotifier {
  final AuthBloc authBloc;
  AuthStreamToListenable({required this.authBloc}) {
...
GoRouter router(AuthBloc authBloc) {
  return GoRouter(
    ...
    refreshListenable: AuthStreamToListenable(authBloc: authBloc),
  );
}
